...
module NewRelic
  ...
  - When you enable [high security mode](/docs/agents/manage-apm-agents/configuration/high-security-mode), this is automatically set to `obfuscated`.'
        ...
        :'instrumentation.aws_seahorse' => {
          :default => 'auto',
          :public => true,
          :type => String,
          :dynamic_name => true,
          :allowed_from_server => false,
          :description => 'Controls auto-instrumentation of the aws_seahorse library at start-up. May be one of [auto|prepend|chain|disabled].'
        },
